          ...
          (
            <Row className='gx-0'>
              ...
              <div className='cart-products d-flex align-items-center row-gap-sm-3'>
                ...
                <Col lg={3} className='product-image-and-quantity d-flex flex-column mb-3'>
                ...
                <Col lg={9} className='product-data text-lg-center d-flex ms-5 ms-lg-3 me-2 mb-2'>
                  ...
                  <Col lg={3}>
                    <div className='cart-item-price fw-semibold ms-2'>₹{item.price}</div>
                  </Col>
