                ...
                <Col xs={12}>
                        ...
                        <CardBody className='text-center'>
                            <Box>
                                <Heading textTransform='uppercase' className='display-title pt-2'>
                                    <img src={display} height={"40px"} width={"40px"} className='animated-img' />Display
                                </Heading>
                    ...
                    <Card className='os-card'>
                        ...
                        <CardBody className='text-center'>
                            <Box>
                                <Heading textTransform='uppercase' className='display-title pt-2'>
                                    <img src={os} height={"40px"} width={"40px"} className='animated-img' /><span className='ps-2'>OS</span>
                                </Heading>
                                <Text className='pt-2 px-2'>{props.os}</Text>
                            </Box>
                        </CardBody>
                    ...
                    <Card className='memory-card'>
                        <CardBody className='text-center'>
                            <Box>
                                <Heading textTransform='uppercase' className='display-title pt-2'>
                                    <img src={ram} height={"30px"} width={"30px"} className='animated-img' /><span className='ps-2'>Memory & Storage</span>
                                </Heading>
                                <Text className='pt-2 px-2'>{props.memory}</Text>
                            </Box>
                        </CardBody>
                    </Card>
                    ...
                    <Card className='ports-card'>
                        <CardBody className='text-center'>
                            <Box>
                                <Heading textTransform='uppercase' className='display-title pt-2'>
                                    <img src={port} height={"30px"} width={"30px"} className='animated-img' /><span className='ps-2'>Ports</span>
                                </Heading>
                                <Text className='pt-2 px-2'>{props.ports}</Text>
                            </Box>
                        </CardBody>
                    </Card>
